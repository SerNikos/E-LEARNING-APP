...
public class SelectQuestionsFinal : MonoBehaviour
{
    ...
    void Awake() {  
        ...
        choice6_1 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question6/ToggleGroup6/Toggle/Answer1").GetComponent<TMP_Text>();
        choice6_2 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question6/ToggleGroup6/Toggle/Answer2").GetComponent<TMP_Text>();
        choice6_3 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question6/ToggleGroup6/Toggle/Answer3").GetComponent<TMP_Text>();
        choice6_4 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question6/ToggleGroup6/Toggle/Answer4").GetComponent<TMP_Text>();

        choice7_1 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question7/ToggleGroup7/Toggle/Answer1").GetComponent<TMP_Text>();
        choice7_2 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question7/ToggleGroup7/Toggle/Answer2").GetComponent<TMP_Text>();
        choice7_3 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question7/ToggleGroup7/Toggle/Answer3").GetComponent<TMP_Text>();
        choice7_4 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question7/ToggleGroup7/Toggle/Answer4").GetComponent<TMP_Text>();

        choice8_1 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question8/ToggleGroup8/Toggle/Answer1").GetComponent<TMP_Text>();
        choice8_2 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question8/ToggleGroup8/Toggle/Answer2").GetComponent<TMP_Text>();
        choice8_3 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question8/ToggleGroup8/Toggle/Answer3").GetComponent<TMP_Text>();
        choice8_4 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question8/ToggleGroup8/Toggle/Answer4").GetComponent<TMP_Text>();

        choice9_1 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question9/ToggleGroup9/Toggle/Answer1").GetComponent<TMP_Text>();
        choice9_2 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question9/ToggleGroup9/Toggle/Answer2").GetComponent<TMP_Text>();
        choice9_3 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question9/ToggleGroup9/Toggle/Answer3").GetComponent<TMP_Text>();
        choice9_4 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question9/ToggleGroup9/Toggle/Answer4").GetComponent<TMP_Text>();

        choice10_1 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question10/ToggleGroup10/Toggle/Answer1").GetComponent<TMP_Text>();
        choice10_2 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question10/ToggleGroup10/Toggle/Answer2").GetComponent<TMP_Text>();
        choice10_3 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question10/ToggleGroup10/Toggle/Answer3").GetComponent<TMP_Text>();
        choice10_4 = GameObject.Find("Canvas/Panel/Scroll View/Viewport/Content/Grid/Question10/ToggleGroup10/Toggle/Answer4").GetComponent<TMP_Text>();
    ...
    public void QuestionSelectorMultipleChoice2Answers(){
        ...
        for (int i = 0; i<data2.Count; i++){
            if (data2[i][0] == firstQ){
                //function to replace text on test
                Question10.text = data2[i][2];
                choice10_1.text = data2[i][3];
                choice10_2.text = data2[i][4];
                choice10_3.text = data2[i][5];
                choice10_4.text = data2[i][6];
            }
        }
    }
}